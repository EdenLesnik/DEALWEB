            ...
            <header className={`main-header header-style-two ${isSearch ? "moblie-search-active" : ""}`}>
                ...
                <div className="auto-container"> 
                    ...
                    <div className="logo-box">
                        <div className="logo"><Link href="/"><img src="/images/logo-2.png" alt="Logo" title="Taxix"/></Link></div>
                    </div>
                    ...
                    <div className="outer-box"> 
                        ...
                        <button className="ui-btn search-btn light" style={ {marginLeft: '30px'}} onClick={handleSearch}> <span className="icon lnr lnr-icon-search"></span> </button>
                        
                        <div className="btn-box"> <Link href="page-booking" className="theme-btn btn-style-one dark-line-two hover-light"><span className="btn-title">הזמן מונית</span></Link> </div>
                        
                        <div className="mobile-nav-toggler light" onClick={handleMobileMenu}><span className="icon lnr-icon-bars"></span></div>
                    </div>
                    </div>
                </div>
                </div>
