      ...
      <div className="auto-container"> 
        ...
        <div className="main-box">
          ...
          <div className="outer-box"> 
            <button className="ui-btn search-btn light" onClick={handleSearch}> <span className="icon lnr lnr-icon-search"></span> </button>
            <div className="btn-box"> <Link href="page-booking" className="theme-btn btn-style-one dark-line-two hover-light"><span className="btn-title">Book a Taxi</span></Link> </div>
