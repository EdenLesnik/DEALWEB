          ...
          <div className="auto-container">
            ...
            <div className="row">
                ...
                <div className="inner-column">
                  ...
                  <div className="benefit-block">
                    <div className="inner-box">
                      <i className="icon flaticon-accept"></i>
                      <div className="content">
                        <h3 className="title">Fixed Price</h3>
                        <div className="text">Lorem ipsum dolor sit amet, cons auctor aliquet. Aenean sollicitudi, bibendum auctor.</div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="image-column col-lg-4 col-md-12 col-sm-12">
                <div className="inner-column">
                  <figure className="image overlay-anim"><img src="/images/resource/benefit1-1.jpg" alt="Image"/></figure>
                </div>
              </div>
              <div className="blocks-column style-two col-lg-4 col-md-6 col-sm-12">
